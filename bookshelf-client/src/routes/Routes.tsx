...
const Main = () => {
    ...
    if(buyStatus) {
        switch(buyStatus) {
            case 'success':
                dispatch(setMessage({content: 'Done! Your payment was credited. Thank you for your order!', variant: 'Success'}));
                break;
            case 'pending':
                dispatch(setMessage({content: 'We are processing your payment.', variant: 'Warning'}));
                break;
            case 'failure':
                dispatch(setMessage({content: "Sorry! Your payment couldn't be processed.", variant: 'Danger'}));
                break;
            default:
                break;
        }
