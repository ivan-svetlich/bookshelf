...
type ACTION = { type: "LOAD", payload: null } | { type: "SUCCESS"; payload: INotification[] } | { type: "FAILURE", payload: string};

const initialState: NotificationState = { loading: false, data: [], error: null };

function fetchNotificationsReducer<NotificationState>(state: NotificationState, action: ACTION) {
