  ...
  return (
    <NavDropdown
      title={
        user?.isAdmin ? (
          <>
            <i className="fas fa-user-lock" title="admin" /> {user!.username}
          </>
        ) : (
          <>{user!.username}</>
        )
    ...
    >
      ...
      <NavDropdown.Item href={`/friends/list/`} className="dropdown-item">
        Friends
      </NavDropdown.Item>
      <NavDropdown.Item
      ...
      <NavDropdown.Item href={`/my_purchases`} className="dropdown-item">
        My Purchases
      </NavDropdown.Item>
      <NavDropdown.Divider />
