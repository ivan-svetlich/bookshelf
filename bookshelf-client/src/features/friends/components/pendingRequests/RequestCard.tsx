    ...
    return (
        <div className="card flex-row flex-wrap request-card">
            ...
            <div className="request-info">     
                ...
                <div className=""><p>Request sent on {friend.createdAt ? getFormattedDateTime(friend.createdAt) : '-/-/-'}</p></div>
                <div className="request-links">
                    <ul>
                        <li><button className="btn btn-link shadow-none" onClick={() => handleShow('accept')}>Accept</button></li>
                        <li><button className="btn btn-link shadow-none" onClick={() => handleShow('decline')}>Decline</button></li>
                    </ul> 
                </div>
            </div>
            <RequestResponse 
