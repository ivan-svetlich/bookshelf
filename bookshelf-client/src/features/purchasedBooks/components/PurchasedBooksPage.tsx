...
const PurchasedBooksPage = () => {
    ...
    const {data, loading, error}: PurchasedBooksState = useAppSelector(state => state.purchasedBooks);
    ...
    return (
        <div>
            ...
            <div className='list-container'>
                <span className="purchased-books-description">Books purchased in BOOKSHELF STORE by {user?.username}</span>
                <div className='row'>
                    <Table striped bordered hover responsive className="purchased-books-list">
                        <thead>
                            <tr>
                                <th>#</th>
                                <th>Title</th>
                        ...
                        <tbody>
                            {data.map(item => (
                                <tr key={item.id}>
                                    <td className="title-col"><a href={`/book/${item.googleBooksId}`}>{item.title}</a></td>
