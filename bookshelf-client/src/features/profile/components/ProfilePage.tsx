            ...
            <Col className="profile-info">
              ...
              <div className="image-container">
                {profileInfo.profilePicture ? (
                  <ProfilePicture
                    source={profileInfo.profilePicture}
                    sourceType="base64"
                  />
                ) : (
                ...
                <tbody>
                  <tr>
                    ...
                    <td className="content-is-right">
                      <span
                        className={
                          checkOnline(profileInfo.lastOnline)
                            ? "text-is-green"
                            : "text-is-grey"
                        }
                      >
                        {checkOnline(profileInfo.lastOnline)
                          ? "Now"
                          : formatDate(profileInfo.lastOnline)}
                      </span>
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td className="content-is-right">
                      {profileInfo.birthday
                        ? profileInfo.birthday.toString().split("T")[0]
                        : "-/-/-"}
                    </td>
                  </tr>
                  <tr>
...
function checkOnline(lastOnline: Date) {
  if (
    DateTime.fromISO(lastOnline.toString(), { zone: "utc" })
      .setZone()
      .diffNow("minutes").minutes > -1
  ) {
    return true;
  } else {
    return false;
